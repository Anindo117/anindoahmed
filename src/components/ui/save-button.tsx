    ...
    <div className="relative">
      <motion.button
        ...
        className={cn(
          ...
          status === "idle"
            ? "before:absolute before:inset-0 before:rounded-full before:p-[2px] before:bg-gradient-to-r before:from-purple-500 before:via-orange-400 before:to-purple-500 before:content-['']"
            : "",
          "hover:shadow-lg",
          className
        )}
      ...
      >
        ...
        <span
          className={cn(
            "backdrop absolute inset-[1px] rounded-[22px] transition-colors duration-200",
            status === "idle"
