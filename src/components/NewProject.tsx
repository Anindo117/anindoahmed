            ...
            <div className="relative z-20 h-full overflow-hidden rounded-3xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-black">
              ...
              <div className="flex justify-center">
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  <div
                    className="relative mx-auto h-[270px] w-[300px] md:h-[270px] md:w-[250px]"
                    ref={scope}
                  >
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link
                        href="mailto:anindo.ah117@gmail.com"
                        target="_blank"
                        className={cn(
                          buttonVariants({
                            variant: "outline",
                      ...
                      <Link
                        href="https://wa.me/+8801673210161"
                        target="_blank"
                        className={cn(
                          buttonVariants({
                            variant: "outline",
